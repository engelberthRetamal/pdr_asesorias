...
<body>
    ...
    <main class="container mx-auto my-5 d-flex flex-column flex-lg-row gap-5">
			...
			<p>Formulario para editar usuario existente, con todas sus
				caracteristicas.</p>
			<div class="contact-img-container w-50">
				<img alt="crear_usuario_img" class="w-100"
					src="https://www.lifeveda.com.my/wp-content/themes/lifeveda-theme/static/img/edit-user.png">
			</div>
		</div>

		<div class="form-container">
			<form id="editForm" action="EditarUsuario" method="post"
				class="col-12">
				<div class="col-sm-12">
					<label for="id" class="form-label">ID:</label> <input type="text"
						name="id" value="<%= request.getAttribute("idUsuario") %>"
						class="form-control" readonly>
				</div>
				<div class="col-sm-12">
					<label for="nombre" class="form-label">Nombre:</label> <input
						type="text" name="nombre"
						value="<%= request.getAttribute("nombreUsuario") %>"
						class="form-control">
				</div>
				<div class="col-sm-12">
					<label for="tipo" class="form-label">Tipo:</label> <input
						type="text" name="tipo"
						value="<%= request.getAttribute("tipoUsuario") %>"
						class="form-control" readonly>
				</div>
				...
				<div id="telefonoDiv">
					<div class="col-sm-12">
						<label for="telefono" class="form-label">Teléfono:</label> <input
							...
							value="<%= ((Cliente) request.getAttribute("usuario")).getTelefono() %>"
				...
				<div id="empleadosDiv">
					<div class="col-sm-12">
						<label for="empleados" class="form-label">Cantidad de
							empleados:</label> <input type="number" name="empleados"
							value="<%= ((Cliente) request.getAttribute("usuario")).getCantidadEmpleados() %>"
				...
				<div id="experienciaDiv">
					<div class="col-sm-12">
						<label for="experiencia" class="form-label">Años de
							experiencia:</label> <input type="number" name="experiencia"
							value="<%= ((Profesional) request.getAttribute("usuario")).getAniosExperiencia() %>"
							class="form-control" min="0" pattern="[0-9]+"
							title="Ingrese un número válido">
					</div>
				</div>
				<div id="departamentoDiv">
					<div class="col-sm-12">
						...
						<input type="text" name="departamento"
							value="<%= ((Profesional) request.getAttribute("usuario")).getDepartamento() %>"
							class="form-control">
					</div>
				</div>
				...
				<div id="cargoDiv">
					<div class="col-sm-12">
						<label for="cargo" class="form-label">Cargo:</label> <input
							...
							value="<%= ((Administrativo) request.getAttribute("usuario")).getCargo() %>"
							class="form-control">
					</div>
				</div>
				<div id="superiorDiv">
					<div class="col-sm-12">
						<label for="superior" class="form-label">Nombre del
							superior del administrativo:</label> <input type="text" name="superior"
							value="<%= ((Administrativo) request.getAttribute("usuario")).getNombreSupervisor() %>"
							class="form-control">
					</div>
				</div>
				<% } %>
